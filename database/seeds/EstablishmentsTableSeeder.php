    ...
    public function run()
    {
        DB::table('establishments')->insert([
            [
                ...
                'site' => 'site1.com',
                'parent' => null,
                'services' => '["servises test"]',
                'content' => 'content Us test 1',
                'category' => 'clinic',
                'spec' => 'test_spec1'
            ],
            [
